...
function RecordCard({ boldContent, fadeContent }) {
  return (
    <Stack
      spacing={1}
      sx={{ borderRadius: "6px", border: "1px solid #E5E5E5", flexGrow: 1,p:'12px' }}
    >
      <Box sx={{position:'relative'}}>
        <Box component="img" sx={{width:'100%'}} src='./record1.png' alt="" />
        <Box component="img" sx={{position:'absolute',top:'40%',left:'43%'}} src='./playButton.svg' alt="" />
